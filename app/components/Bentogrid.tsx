...
export const Bentogrid = () => {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 grid-rows-3">
      ...
      <div className="bg-client_bg bg-cover bg-no-repeat bg-center md:bg-left row-span-2 rounded-2xl overflow-hidden relative group order-2">
      ...
      <div className="bg-scoop_bg bg-cover bg-no-repeat bg-center md:bg-left row-span-2 rounded-2xl relative overflow-hidden border-[1px] border-onimisea_text_light bg-transparent group h-[300px] md:h-auto order-last md:order-4">
        <div className="bg-black_transparent p-6 h-full w-full absolute"></div>
