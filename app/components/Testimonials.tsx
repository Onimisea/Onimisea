...
export const Testimonials = () => {
  return (
    ...
    >
      <div className="w-full mx-auto flex flex-col justify-center items-center pt-10 pb-20 gap-10 duration-500">
        ...
        <div className="w-full relative mt-6 transition-all duration-500">
          <Swiper
            slidesPerView={1}
            spaceBetween={30}
            loop={true}
          ...
          >
            <div className="">
              {testimonials.map((tes, i) => (
                <SwiperSlide
                  key={i}
                  className="bg-onimisea_text_light rounded-lg p-6"
                >
          ...
          <div className="absolute bottom-0 left-0 pointer-events-none bg-gradient-to-r from-black-100 to-transparent z-75 h-full w-[35%]" />
          <div className="absolute bottom-0 right-0 pointer-events-none bg-gradient-to-l from-black-100 to-transparent z-75 h-full w-[35%]" />
        </div>
      </div>
    </div>
  );
