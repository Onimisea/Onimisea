...
<section className="w-[230px] h-[230px] rounded-full bg-gradient-primsec-ir group-hover:bg-gradient-primsec-i
 grid place-items-center shadow-lg overflow:hidden">
<section className="w-[220px] h-[220px] rounded-full bg-white grid place-items-center">
<Image src={opp} alt="Onimisea | Coolest Dev in Africa" width={217} height={217} loading="eager" className="w-[217px] h-[217px] rounded-full object-cover" />
</section>
</section>
