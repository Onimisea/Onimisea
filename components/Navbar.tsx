...
const Navbar = () => {
  return (
    <header className="bg-white dark:bg-onimisea_text_light dark:text-onimisea_secondary_light fixed top-0 z-40 w-full h-20 flex items-center justify-center">
      <section className="w-[80%] sm:w-[85%] md:w-[90%] mx-auto max-w-screen-2xl flex items-center justify-between text-md font-[600]">
        <Link href="/">
          <h1 className="text-3xl font-milkbold bg-gradient-to-r from-[#3219c8] via-[#007fff] to-[#3219c8] text-transparent bg-clip-text tracking-widest">
            onimisea
          </h1>
        </Link>
