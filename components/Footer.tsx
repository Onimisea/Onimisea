...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary dark:bg-background2 text-white z-30 w-full">
      <section className="w-[80%] sm:w-[85%] md:w-[90%] mx-auto max-w-screen-2xl flex items-start justify-around py-16 text-md font-[500]">
        <section className="w-[25%] flex flex-col items-center justify-center gap-6">
          <Link
            href="/"
        ...
        <ul className="w-[10%] flex flex-col items-start gap-4">
          <li className="w-full">
        ...
        <ul className="w-[20%] flex flex-col items-start gap-4">
          <li className="w-full">
            <Link
