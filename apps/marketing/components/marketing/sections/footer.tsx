export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-white/[0.06] bg-onimisea-void py-[34px]">
      <div
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(148,163,184,0.055)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.055)_1px,transparent_1px)] [mask-image:radial-gradient(ellipse_70%_100%_at_50%_50%,#000_0%,transparent_82%)] bg-[length:44px_44px]"
        aria-hidden="true"
      />
