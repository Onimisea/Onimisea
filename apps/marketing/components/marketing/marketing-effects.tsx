    ...
    function draw() {
      ...
      for (let i = 0; i < nodes.length; i += 1) {
        for (let j = i + 1; j < nodes.length; j += 1) {
          ...
          if (distance < maxDistance) {
            ctx.beginPath()
            ctx.strokeStyle = `rgba(135,47,24,${(1 - distance / maxDistance) * 0.18})`
            ctx.lineWidth = 0.8
      ...
      nodes.forEach((node) => {
        ...
        if (node.pulse) {
          ...
          ctx.fillStyle = "rgba(135,47,24,.035)"
          ctx.fill()
          ctx.beginPath()
          ctx.arc(node.x, node.y, node.r * 3.2 * scale, 0, Math.PI * 2)
          ctx.fillStyle = "rgba(135,47,24,.09)"
          ctx.fill()
        }

        ctx.beginPath()
        ctx.arc(node.x, node.y, node.r, 0, Math.PI * 2)
        ctx.fillStyle = node.pulse ? "rgba(135,47,24,.92)" : "rgba(135,47,24,.4)"
        ctx.fill()
      })
      ...
      const fixed = [
        { x: cx - 210, y: cy + 18, r: 4, c: "135,47,24" },
        { x: cx - 92, y: cy - 56, r: 5, c: "135,47,24" },
        { x: cx + 42, y: cy - 22, r: 4, c: "212,144,15" },
        { x: cx + 154, y: cy + 42, r: 5, c: "135,47,24" },
        { x: cx + 235, y: cy - 68, r: 3, c: "212,144,15" },
      ]
      ...
      for (let index = 0; index < fixed.length - 1; index += 1) {
        ...
        ctx.beginPath()
        ctx.strokeStyle =
          index === 1 ? "rgba(212,144,15,.32)" : "rgba(135,47,24,.32)"
        ctx.lineWidth = 1.2
